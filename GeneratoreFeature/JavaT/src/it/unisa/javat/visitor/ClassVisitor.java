...
public class ClassVisitor extends ASTVisitor {
  ...
  private static final int i = 0;
	...
	public ClassVisitor(CompilationUnit compilation, Document document, ASTRewrite rewriter, ArrayList<Feature> arrayListFeatureVisitor, String folder,String nomeProgetto) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (binding.isInterface()) {
			...
			if(bool=cercaSottostringaClasse(nomeClasse,"Subject")) {
				feat.setClassDeclarationKeyword(1);
			} 
			else if (bool=cercaSottostringaClasse(nomeClasse,"Observer")) {
