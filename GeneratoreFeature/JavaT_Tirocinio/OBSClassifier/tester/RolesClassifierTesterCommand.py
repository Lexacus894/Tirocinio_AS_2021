...
def main():
    ...
    p_utils.log_combinations_on_file(InstancesClassifierTesterCommand.INSTANCES_COMBINATIONS_FILE_PATH, InstancesClassifierTesterCommand.INSTANCES_COMBINATIONS_HEADER, classes_triplets_act, classes_quadruplets_act, classes_quintuplets_act, classes_triplets_roles, classes_quadruplets_roles, classes_quintuplets_roles)
