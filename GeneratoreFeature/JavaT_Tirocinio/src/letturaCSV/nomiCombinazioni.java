...
public class nomiCombinazioni {
	...
	/*
	 * public nomiCombinazioni(String classe1, String classe2, String classe3,
	 * String classe4, String classe5) {
	 * super();
	 * this.classe1 = classe1;
	 * this.classe2 = classe2;
	 * this.classe3 = classe3;
	...
	public String toString() {
		return "nomiCombinazioni [classe1 = " + classe1 + ", classe2 = " + classe2 + ", classe3 = " + classe3
				+ ", classe4 = "
