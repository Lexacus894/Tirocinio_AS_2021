...
def main():
    ...
    classes_pairs_pred,classes_triplets_pred, classes_quadruplets_pred = p_utils.roles_combinations(roles_predictions_list)
    ...
    p_utils.log_combinations_on_file(INSTANCES_COMBINATIONS_FILE_PATH, INSTANCES_COMBINATIONS_HEADER, classes_pairs_act, classes_triplets_act, classes_quadruplets_act, classes_pairs_roles, classes_triplets_roles, classes_quadruplets_roles)
